...
from tobrot import DOWNLOAD_LOCATION, D_STATUS
...
async def upload_as_doc(client, message):
   D_STATUS.UPLOAD_AS_DOC = "True"
   dahp = await message.reply_text("Now File will be upload as Doc 📚", quote=True)

async def upload_as_stream(client, message):
   D_STATUS.UPLOAD_AS_DOC = "False"
   dah_p = await message.reply_text("Now File will be upload as Stream 🎞️", quote=True)
